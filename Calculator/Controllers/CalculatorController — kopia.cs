    ...
    public class CalculatorController : Controller
    {
        ...
        public IActionResult SetFunction(string function)
        {
            ...
            switch (function)
            {
                ...
                case "power":
                    {
                        Calc.DisplayedNumber = (Convert.ToDouble(Calc.DisplayedNumber) * Convert.ToDouble(Calc.DisplayedNumber)).ToString();
                        Calc.Formula += "²";
                        break;
                    }
                case "root":
        ...
        public void Calculate()
        {
            ...
            else if (Calc.DisplayedNumber != null && Calc.DisplayedNumber.Length > 0)
            {
                ...
                switch (Calc.Action)
                {
                    ...
                    case "percentage":
                        Calc.ResultNumber = Convert.ToDouble(Calc.ResultNumber) * (Convert.ToDouble(Calc.DisplayedNumber) / 100);
                        break;

                    case "fraction":
                        Calc.ResultNumber = 1 / Convert.ToDouble(Calc.DisplayedNumber);
                        break;

                    case "power":
                        Calc.ResultNumber = Convert.ToDouble(Calc.ResultNumber) * Convert.ToDouble(Calc.ResultNumber);
                        break;
